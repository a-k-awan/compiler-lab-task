...
#line 79 "example.tab.c" /* yacc.c:339  */
...
{
  "$end", "error", "$undefined", "NUM", "';'", "'+'", "$accept",
  "exprlist", "expr", "term", YY_NULLPTR
};
#endif
...
#line 1197 "example.tab.c" /* yacc.c:1646  */
      default: break;
    }
